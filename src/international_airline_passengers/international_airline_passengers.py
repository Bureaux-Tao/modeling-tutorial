...
early_stopping = EarlyStopping(monitor='loss', patience=15, verbose=1)  # 提前结束
model.fit(trainX, trainY, epochs=500, batch_size=8, verbose=2, callbacks=[early_stopping])
...
print('testPredict-inverse_transform:')
print(testPredict.shape)
print(testPredict)

print('testY-inverse_transform:')
print(testY.shape)
print(testY)
...
model.save_weights('../../models/international-airline-passengers.h5')
